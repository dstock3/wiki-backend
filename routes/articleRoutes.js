...
router.post('/', ensureAuthenticated, csrfProtection, upload.single('image'), parseFormData, ...articleValidationRules, articleController.createArticle);
...
router.put('/:articleId', ensureAuthenticated, csrfProtection, upload.single('image'), parseFormData, ...articleValidationRules, articleController.updateArticle);
