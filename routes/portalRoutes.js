...
router.post('/', ensureAuthenticated, csrfProtection, upload.single('image'), portalController.createPortal);
router.put('/:portalId', ensureAuthenticated, csrfProtection, upload.single('image'), portalController.updatePortal);
